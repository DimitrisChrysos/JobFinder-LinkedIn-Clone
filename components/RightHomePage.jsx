...
const RightHomePage = ({ user, current_post_counter, setCurrentPostCounter}) => {
    ...
    const makePost = async () => {
        const path = file ? join('assets', 'post_files', `${user.post_counter}_${user.email}_${file.name}`) 
        : null;
        ...
        setCurrentPostCounter(current_post_counter + 1);
    }
